        ...
        <div id="container">
            ...
            <form id="summary" action="viewresult.php" method="post">
              ...
              ?>
                        ...
                        <input type="submit" value="Back" name="back" class="subbtn" title="View Results"/>
                        <?php
                        }
                        else
                        {
                ...
                <div class="page">
                        ...
                        if(isset($_REQUEST['details'])) {
                            ...
                            if(mysql_num_rows($result)!=0) {
                                ...
                                ?>
                    <table cellpadding="20" cellspacing="30" border="0" style="text-align:left;line-height:20px;">
                        <tr>
